...
namespace MyRI.Anima2D.Scripts.Editor.OnionSkin
{
	...
	public class OnionLayerManager
	{
		...
		public void UpdateOnionLayers(AnimationClip clip, int frame, int offset, int step, float alphaMultiplier, Color colorPrevFrames, Color colorNextFrames)
		{
			...
			int frameCount = (int)(AnimationWindowExtra.AnimationWindowExtra.activeAnimationClip.length * AnimationWindowExtra.AnimationWindowExtra.activeAnimationClip.frameRate);
