...
namespace MyRI.Anima2D.Scripts.Editor.Triangle.IO
{
    ...
    public static class FileReader
    {
        ...
        public static List<Geometry.Edge> ReadEdgeFile(string edgeFile, int invertices)
        {
            // Read poly file
            List<Geometry.Edge> data = null;
            ...
            using (StreamReader reader = new StreamReader(edgeFile))
            {
                ...
                if (inedges > 0)
                {
                    data = new List<Geometry.Edge>(inedges);
                }
                ...
                for (int i = 0; i < inedges; i++)
                {
                    ...
                    {
                        data.Add(new Geometry.Edge(end1, end2, mark));
                    }
                }
            }
