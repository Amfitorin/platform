...
using MyRI.Anima2D.Scripts.Editor.Triangle.Algorithm;
using MyRI.Anima2D.Scripts.Editor.Triangle.Data;
using MyRI.Anima2D.Scripts.Editor.Triangle.Geometry;
using MyRI.Anima2D.Scripts.Editor.Triangle.IO;
using MyRI.Anima2D.Scripts.Editor.Triangle.Log;
using MyRI.Anima2D.Scripts.Editor.Triangle.Smoothing;
using MyRI.Anima2D.Scripts.Editor.Triangle.Tools;

namespace MyRI.Anima2D.Scripts.Editor.Triangle
{
    ...
    public class Mesh
    {
        ...
        internal Dictionary<int, Data.Triangle> triangles;
        ...
        internal static Data.Triangle dummytri;
        ...
        /// </summary>
        public ICollection<Data.Triangle> Triangles
        {
        ...
        /// Gets the mesh edges.
        /// </summary>
        public IEnumerable<Geometry.Edge> Edges
        {
            get
            {
        ...
        public Mesh(Behavior behavior)
        {
            ...
            triangles = new Dictionary<int, Data.Triangle>();
        ...
        {
            Data.Triangle tri = new Data.Triangle();
        ...
        internal void TriangleDealloc(Data.Triangle dyingtriangle)
        {
